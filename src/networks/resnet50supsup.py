...
class ResNet50_32SUPSUP(nn.Module):
    ''' input size: 3 channels x 32 pixels x 32 pixels '''
    ''' replaced nn.Linear with SupSup_MaskLinear in the classifier block.'''
    ...
    def __init__(self, block: Union[BasicBlock, BottleNeck], num_block: list,
        ...
        self.classifier = nn.Sequential(
            ...
            SupSup_MaskLinear(512*block.expansion, 512*block.expansion, bias=False, num_tasks=num_tasks, device=device, dtype=torch.float64),
...
def resnet50_32supsup(device=None, **kwargs):
    return ResNet50_32SUPSUP(BottleNeck, [3, 4, 6, 3], device, **kwargs)
