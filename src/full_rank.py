...
def main(argv=None):
    ...
    from approach_rank.incremental_learning import Inc_Learning_Appr
    Appr = getattr(importlib.import_module(name='approach_rank.' + args.approach), 'Appr')
